...
from data.data import PersonalData
...
class TestOrderListPageFunctions:
    ...
    def test_total_counter_after_order(self, driver):
        main_page = MainPage(driver)
        order_list_page = OrdersListPage(driver)
        driver.get(Urls.MAIN_PAGE_URL)
        main_page.login_user(PersonalData.EMAIL, PersonalData.PASSWORD)
    ...
    def test_today_counter_after_order(self, driver):
        main_page = MainPage(driver)
        order_list_page = OrdersListPage(driver)
        driver.get(Urls.MAIN_PAGE_URL)
        main_page.login_user(PersonalData.EMAIL, PersonalData.PASSWORD)
